...
export default function Footer() {
  return (
    <footer className="bg-white absolute top-[5100px] left-[0px] w-[1348px]">
      {/* Top Section */}
      <section className="bg-[#f9f9f9] py-10">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          <div className="flex flex-col">
            <h1 className="text-[#252b42] ml-28 text-2xl font-bold leading-loose tracking-tight">Bandage</h1>
          </div>
      ...
      <section className="bg-[#f9f9f9] py-4">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          <p className="text-[#727272] text-sm font-bold ml-28">Made with love by Finland. All rights reserved.</p>
        </div>
      </section>
    </footer>
  );
